...
module Jekyll
  ...
  class CategoryIndex < Page
    ...
    def initialize(site, base, category_dir, category)
      ...
      title_suffix             = site.config['category_title_suffix'] || ''
      self.data['title']       = "#{title_prefix}#{category}#{title_suffix}"
...
##---
# The CategoryIndex class creates a single category page for the specified category.
class CategoryRecentIndex < Page
  ...
  class Site
    ...
    def write_category_index(category_dir, category)
      ...
      feed = CategoryRecentIndex.new(self, self.source, category_dir, category)
